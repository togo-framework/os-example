// Command api is the os-example HTTP entrypoint. It boots the shared togo stack
...
import (
	...
	"github.com/togo-framework/os-example/internal/server"
)
...
func main() {
	...
	k := a.Kernel
	fmt.Printf("→ os-example listening on %s  (GraphQL %s · REST %s · docs %s)\n",
